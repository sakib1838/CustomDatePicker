...
import 'package:testdate/SingleDatePicker/month_heading_single_date.dart';
import 'package:testdate/SingleDatePicker/singledates.dart';
import 'package:testdate/listofdates.dart';
import 'package:testdate/month_heading.dart';

class AllSingleData extends StatefulWidget {
  const AllSingleData({Key? key,required this.dateTimes,required this.startDate,required this.endDate}) : super(key: key);
  final Function(DateTime)? dateTimes;
  ...
  @override
  State<AllSingleData> createState() => _AllSingleDataState();
}

class MonthAndYearSingleDate{
  int month;
  int year;

  MonthAndYearSingleDate(this.month,this.year);
}

class _AllSingleDataState extends State<AllSingleData> {
  ...
  List<MonthAndYearSingleDate> months =[];
  List<DateTime> date=[];
  ...
  Future<void> countMonth() async{
    if(start.year<end.year){
        ...
        months.add(MonthAndYearSingleDate(start.month,start.year));
                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      return Container(child: Column(
                        children: [
                          SizedBox(height: 10,),
                          MonthHeadingSingleDate(monthAndYear: months[index],),
                          SizedBox(height: 10,),
                          SingleDateList(dateTime: DateTime(months[index].year,months[index].month), startDate: startDate,endDate: endDate, selectedDate: (selectedDate ) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Visibility(
                              child: Text("${DateFormat('dd MMM').format(startDate!)}",style: TextStyle(fontWeight: FontWeight.bold),)),
